let CreateAccContent = '<div class="form1"><h2>SignUp</h2><h6>Stay updated on your chit chats</h6><form method="POST" class="signup"><input type="text" id="usrname" placeholder="Username" autofocus ><input type="email" id="email" placeholder="Email"><br><input type="password" id="passw" placeholder="Create Password" required><br><input type="password" id="passwr" placeholder="Confirm Password" required><br><input type="number" placeholder = "Enter 10 Digit Phone Number"  id="phone"><br><input type="submit" value="Create" class="sign"><span class="shows" onclick= "shows()" >show password</span><span class="logins" onclick="LoginPage()">Already have an Account?</span></form></div>';
